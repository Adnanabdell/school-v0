  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-950 min-h-screen transition-colors">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{t('subjects_title')}</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">{t('subjects_subtitle')}</p>
        </div>
        <button
          onClick={() => openModal()}
